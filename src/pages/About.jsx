  ...
  return (
    <div className="relative bg-custom-1 overflow-hidden" style={{ backgroundImage: 'url(/wp-content/themes/openmind/assets/images/lines-2.png)', backgroundPosition: 'center', backgroundSize: 'contain' }}>
      ...
      <div ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div 
          className="relative px-8 lg:px-12 py-20 pt-32 z-10 max-w-5xl mx-auto text-center"
      ...
      <div className="relative py-12 overflow-hidden bg-custom-9 border-y border-custom-8">
            ...
            <div key={setIdx} className="flex items-center">
              {['AI Innovation', 'RLHF Training', 'Expert Talent', 'Custom Solutions', 'Model Optimization', 'AI Strategy'].map((text, idx) => (
                <div key={idx} className="inline-flex items-center mx-8">
                  <span className="text-custom-7 text-3xl mx-4">♢</span>
                  <span className="text-white text-2xl font-medium">{text}</span>
                </div>
              ))}
            </div>
          ))}
      ...
      <div 
        ref={addToRefs}
        data-section="about"
        className={`relative px-8 lg:px-12 py-16 lg:py-24 mt-20 lg:mt-32 mb-20 lg:mb-32 transition-all duration-1000 ${visibleSections.has('about') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
      >
        <div className="max-w-7xl mx-auto flex flex-wrap gap-12 lg:gap-16">
          <div className={`flex-1 min-w-[300px] transition-all duration-1000 delay-100 ${visibleSections.has('about') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          ...
          <div className={`flex-1 min-w-[300px] transition-all duration-1000 delay-300 ${visibleSections.has('about') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
      ...
      <div 
        ...
        className={`relative px-8 lg:px-12 py-16 lg:py-24 mt-20 lg:mt-32 mb-20 lg:mb-32 transition-all duration-1000 ${visibleSections.has('what-we-do') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
      >
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div 
                key={idx} 
                className={`bg-custom-9 p-10 lg:p-12 flex flex-col items-center text-center hover:bg-opacity-80 transition-all duration-500 hover:scale-105 hover:shadow-xl group ${visibleSections.has('what-we-do') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
                style={{ transitionDelay: `${idx * 150}ms` }}
              >
                <p className="text-custom-7 font-black text-5xl mb-6 group-hover:scale-110 group-hover:rotate-180 transition-all duration-500">♢</p>
          ...
          {[...Array(2)].map((_, setIdx) => (
            <div key={setIdx} className="flex items-center">
              {[
                ...
                <div key={idx} className="inline-flex flex-col items-center mx-16 px-8">
                  <span className="text-custom-7 text-5xl font-bold mb-2">{stat.num}</span>
                  <span className="text-white text-sm uppercase tracking-wider">{stat.label}</span>
                </div>
              ))}
            </div>
          ))}
      ...
      <div 
        ...
        className={`relative px-8 lg:px-12 py-16 lg:py-24 transition-all duration-1000 ${visibleSections.has('services-grid') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            {[
              ...
              <div 
                key={idx} 
                className={`relative bg-cover bg-center min-h-[450px] border border-custom-8 p-12 lg:p-16 group overflow-hidden transition-all duration-700 ${visibleSections.has('services-grid') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
                style={{ 
              ...
              >
                ...
                <div className="relative flex flex-col justify-between h-full">
                  <div className="flex justify-between items-start mb-6">
                    ...
                    <p className="text-custom-7 text-2xl group-hover:translate-x-2 group-hover:scale-125 transition-all duration-300">→</p>
                  </div>
      ...
      <div 
        ...
        className={`relative px-8 lg:px-12 py-16 lg:py-24 mt-20 lg:mt-32 mb-20 lg:mb-32 transition-all duration-1000 ${visibleSections.has('features') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}
      >
        <div className="max-w-7xl mx-auto flex flex-wrap gap-12 lg:gap-16">
          <div className={`flex-1 min-w-[300px] transition-all duration-1000 delay-100 ${visibleSections.has('features') ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
          ...
          <div className={`flex-1 min-w-[300px] transition-all duration-1000 delay-300 ${visibleSections.has('features') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
            ...
            <ul className="list-none space-y-4 text-custom-6 text-sm">
              {[
                ...
                <li 
                  key={idx} 
                  className={`flex items-start gap-3 group transition-all duration-500 ${visibleSections.has('features') ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-10'}`}
                  style={{ transitionDelay: `${500 + idx * 100}ms` }}
                >
                  <span className="w-6 h-6 border-2 border-custom-7 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 text-custom-7 text-xs group-hover:bg-custom-7 group-hover:text-white group-hover:scale-110 transition-all duration-300">✓</span>
      ...
      <div className="relative py-16 lg:py-24 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className={`relative w-full md:w-1/2 bg-gradient-to-br from-custom-9 to-black p-12 lg:p-20 flex flex-col justify-center transition-all duration-1000 ease-out ${visibleSections.has('mission') ? 'md:translate-x-0 opacity-100' : 'md:-translate-x-full opacity-0'}`}>
              <div className="absolute top-0 left-0 w-1 h-full bg-gradient-to-b from-custom-2 via-custom-7 to-custom-2"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-12 h-12 bg-gradient-to-br from-custom-2 to-custom-7 rounded-lg flex items-center justify-center text-white text-2xl font-bold">M</div>
                  <h3 className="text-white font-bold text-3xl lg:text-4xl">Our Mission</h3>
                </div>
                <div className="w-20 h-1 bg-gradient-to-r from-custom-2 to-custom-7 mb-8"></div>
                <p className="text-custom-6 text-base lg:text-lg leading-relaxed mb-6">
                ...
                <div className="flex items-center gap-3 text-custom-7 text-sm">
            ...
            <div className={`relative w-full md:w-1/2 overflow-hidden transition-all duration-1000 delay-300 ${visibleSections.has('mission') ? 'scale-100 opacity-100' : 'scale-90 opacity-0'}`}>
              ...
              <img 
                ...
                alt="Our Mission" 
                className="w-full h-full min-h-[400px] md:min-h-[500px] object-cover hover:scale-110 transition-transform duration-700" 
              />
          ...
          >
            ...
            <div className={`relative w-full md:w-1/2 bg-gradient-to-bl from-custom-9 to-black p-12 lg:p-20 flex flex-col justify-center transition-all duration-1000 delay-200 ease-out ${visibleSections.has('vision') ? 'md:translate-x-0 opacity-100' : 'md:translate-x-full opacity-0'}`}>
              <div className="absolute top-0 right-0 w-1 h-full bg-gradient-to-b from-custom-7 via-custom-2 to-custom-7"></div>
              <div className="relative z-10">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-12 h-12 bg-gradient-to-br from-custom-7 to-custom-2 rounded-lg flex items-center justify-center text-white text-2xl font-bold">V</div>
                  <h3 className="text-white font-bold text-3xl lg:text-4xl">Our Vision</h3>
                </div>
                <div className="w-20 h-1 bg-gradient-to-r from-custom-7 to-custom-2 mb-8"></div>
                <p className="text-custom-6 text-base lg:text-lg leading-relaxed mb-6">
      ...
      <div 
        ref={addToRefs}
        data-section="cta"
        className={`relative px-8 lg:px-12 py-16 lg:py-24 mt-20 lg:mt-32 mb-20 lg:mb-32 transition-all duration-1000 ${visibleSections.has('cta') ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}
      >
        <div className="max-w-7xl mx-auto bg-custom-9 flex flex-wrap gap-12 items-center p-12 lg:p-20 hover:bg-opacity-80 transition-all duration-300">
          <div className={`flex-1 min-w-[300px] transition-all duration-700 delay-100 ${visibleSections.has('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className={`flex-1 min-w-[300px] transition-all duration-700 delay-300 ${visibleSections.has('cta') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
