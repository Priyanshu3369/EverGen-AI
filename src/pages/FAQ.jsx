...
const FAQ = () => {
  ...
  const FAQItem = ({ id, question, answer }) => (
    <div className="bg-custom-9 overflow-hidden transition-all duration-300 hover:shadow-lg flex-shrink-0 rounded-lg">
      <button
        onClick={() => toggleFaq(id)}
        className="w-full p-4 sm:p-6 md:p-8 text-left flex justify-between items-start gap-3 sm:gap-4 hover:bg-opacity-90 transition-all duration-300"
      >
        <span className="text-white text-sm sm:text-base font-medium leading-relaxed pr-2">{question}</span>
        <span className={`text-white text-xl sm:text-2xl transition-transform duration-300 flex-shrink-0 ${openFaq[id] ? 'rotate-45' : ''}`}>
          +
        </span>
      </button>
      <div
      ...
      >
        <div className="px-4 sm:px-6 md:px-8 pb-4 sm:pb-6 md:pb-8">
          <div className="pt-4 sm:pt-6 border-t border-custom-3">
            <p className="text-[#ffffffb5] text-xs sm:text-sm leading-relaxed">{answer}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative bg-custom-1 overflow-hidden" style={{ backgroundImage: 'url(/wp-content/themes/openmind/assets/images/lines-2.png)', backgroundPosition: 'center', backgroundSize: 'contain' }}>
      ...
      {/* Hero Section - Added extra top padding here (pt-32 etc) */}
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-16 pt-32 pb-16 sm:pt-40 sm:pb-20 md:pt-48 md:pb-24 lg:pt-56 lg:pb-32">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-custom-6 text-sm sm:text-base lg:text-lg leading-relaxed animate-fade-in-delay px-2 sm:px-4">
      ...
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-16 py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className={`flex flex-col justify-center lg:pr-8 transition-all duration-1000 delay-200 ${
              ...
              <p className="text-[#ffffffa3] text-sm sm:text-base leading-relaxed">
            ...
            <div className={`bg-[#1a1a2e] p-4 sm:p-6 md:p-8 lg:p-10 rounded-lg transition-all duration-1000 delay-400 ${
              isVisible['ai-solutions-faq'] ? 'translate-x-0 opacity-100' : 'lg:translate-x-20 opacity-0'
            }`}>
      ...
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-16 py-12 sm:py-16 lg:py-24">
        <div className="max-w-7xl mx-auto">
          ...
          >
            {/* Text Section - Shows first on mobile, second on desktop */}
            <div className={`flex flex-col justify-center lg:pl-8 lg:order-2 transition-all duration-1000 delay-200 ${
              ...
              <p className="text-[#ffffffa3] text-sm sm:text-base leading-relaxed lg:text-right">
            ...
            {/* FAQ Items - Shows second on mobile, first on desktop */}
            <div className={`bg-[#1a1a2e] p-4 sm:p-6 md:p-8 lg:p-10 rounded-lg lg:order-1 transition-all duration-1000 delay-400 ${
              isVisible['talent-pool-faq'] ? 'translate-x-0 opacity-100' : 'lg:-translate-x-20 opacity-0'
            }`}>
              <div className="flex flex-col gap-3 sm:gap-4">
                <FAQItem
      ...
      {/* CTA Section */}
      <div className="relative px-4 sm:px-6 md:px-8 lg:px-16 py-16 sm:py-20 lg:py-32 mt-12 sm:mt-16 lg:mt-24">
        <div className="max-w-7xl mx-auto">
          <div 
            id="cta-section" 
            data-animate
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 items-center">
              ...
              <div className="p-6 sm:p-8 md:p-10 lg:p-16 order-1">
                ...
                <p className="text-white text-sm sm:text-base leading-relaxed mb-6 sm:mb-8 opacity-90">
                ...
                <a
                  href="/contact"
                  className="inline-block bg-gradient-to-r from-custom-2 to-custom-7 text-white px-6 sm:px-8 md:px-10 py-3 sm:py-4 rounded-md border-2 border-custom-1 uppercase text-xs sm:text-sm font-outfit tracking-wider hover:scale-105 hover:shadow-xl transition-all duration-300"
                >
                  Get in touch
                </a>
              </div>
